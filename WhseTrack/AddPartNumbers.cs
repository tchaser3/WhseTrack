    ...
    public partial class AddPartNumbers : Form
    {
        ...
        private void AddPartNumbers_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception Ex)
            {
                ...
                TheEventLogClass.InsertEventLogEntry(DateTime.Now, "Whse Track Add Part Numbers Form Load " + Ex.Message);
            }
        ...
        private void txtPartNumber_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                intLength = txtPartNumber.Text.Length;
        ...
        private void btnUpdateParts_Click(object sender, EventArgs e)
        {
            ...
            {
                TheEventLogClass.InsertEventLogEntry(DateTime.Now, "Whse Track Add Part Numbers Update Part Button " + Ex.Message);
