    ...
    public partial class CreateNewPart : Form
    {
        ...
        private void CreateNewPart_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception Ex)
            {
                ...
                //event log entry
                TheEventLogClass.CreateEventLogEntry("WhseTrack Create New Part Form Load " + Ex.Message);
            }
        }
        private bool CheckForNull()
        {
            ...
            catch (Exception Ex)
            {
                ...
                TheEventLogClass.CreateEventLogEntry("WhseTrack Create New Part Check for Null " + Ex.Message);
            }
        ...
        private bool UpdatePartTable(string strJDEPartNumber, string strPartNumber, string strDescription)
        {
            ...
            catch (Exception Ex)
            {
                ...
                TheEventLogClass.CreateEventLogEntry("WhseTrack Update Part Table " + Ex.Message);
            }
        ...
        private void FillPartTable(string strJDEPartNumber, string strPartNumber, string strDescription)
        {
            ...
            catch (Exception Ex)
            {
                ...
                TheEventLogClass.CreateEventLogEntry("WhseTrack Fill Part Table " + Ex.Message);
            }
        }
