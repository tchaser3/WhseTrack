    ...
    public partial class CheckInventoryTables : Form
    {
        ...
        private void CheckInventoryTables_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception Ex)
            {
                ...
                TheEventLogClass.CreateEventLogEntry("Whse Track Check Inventory Tables Form Load " + Ex.Message);
            }
        }
        ...
        private void cboSelectTable_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            catch (Exception Ex)
            {
                ...
                TheEventLogClass.CreateEventLogEntry("Whse Track Check Inventory Table Selected Table Combo box " + Ex.Message);
            }
